...
import GeneratePodcasts from "@/components/GeneratePodcasts"
          ...
          <div className="flex flex-col gap-[30px] border-b border-black-5 pb-10">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Select onValueChange={(value) => setVoiceType(value)}>
                ...
                <SelectContent className="text-15 border-none bg-black-1 font-bold text-white-1 focus:ring-orange-1">
